...
基于 [dufs](https://github.com/sigoden/dufs) 的图形界面版本。**不用配置，不用教**——一台设备装好 inout 点一下启动，其他设备打开浏览器就能传文件，对方什么都不用装。
...
> **对方不用装任何东西** — 一台设备装 inout，启动服务，其他人打开浏览器就能传文件。
...
**Q: 最大能传多大的文件？**
A: 理论上取决于 dufs 和浏览器，单文件建议 2GB 以内。
