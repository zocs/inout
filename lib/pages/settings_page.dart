                ...
                child: Row(
                  children: [
                    ...
                    if (!(_cachedStorageGranted ?? false))
                      FilledButton.tonal(
                        onPressed: (_cachedStorageGranted == null)
                            ? _checkStorage
                            : _requestStorage,
                        child: Text(
                          (_cachedStorageGranted == null)
                              ? l10n.t('settings.checkPerm')
                              : l10n.t('settings.grantPerm'),
                          style: const TextStyle(fontSize: 12),
                        ),
                      ),
                    if (_cachedStorageGranted ?? false)
